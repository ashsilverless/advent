...
var airdate = new Date('June 25 2019 12:00:00 GMT');
...
function run_clock(id,endtime){
	...
	var days_span = clock.querySelector('.the_days');
	var hours_span = clock.querySelector('.the_hours');
	var minutes_span = clock.querySelector('.the_minutes');
	var seconds_span = clock.querySelector('.the_seconds');
